...
def angleChecker(pln, pt):
    vBA = convert2Vec(pln[2], pln[0])       
    vBC = convert2Vec(pln[2], pln[3])        
    vBP = convert2Vec(pln[2], pt)        
    
    vDA = convert2Vec(pln[4], pln[0])       
    vDC = convert2Vec(pln[4], pln[3])        
    vDP = convert2Vec(pln[4], pt)         
